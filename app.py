...
if 'report' in globals() and report.get("full_detail") is not None and not report["full_detail"].empty:
    try:
        from export_pdf import build_dashboard_pdf  # lazy import after app & data are loaded
    except Exception as _e:
        build_dashboard_pdf = None

    if build_dashboard_pdf:
