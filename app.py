...
def build_pdf(report: Dict[str, Any], date_label: str) -> bytes:
    ...
    px_widths = [200, 90, 90, 200, 420, 420]
    ...
    for craft_name, payload in report["groups"]:
        ...
        # Convert all cells to Paragraph for wrapping (esp. Problem/Description/Name/Type)
        data = []
        ...
        tbl.setStyle(TableStyle([
            ...
            ("ALIGN", (1,1), (1,-1), "RIGHT"),  # Work Order #
            ("ALIGN", (2,1), (2,-1), "RIGHT"),  # Sum of Hours
        ]))
        story.append(tbl)
