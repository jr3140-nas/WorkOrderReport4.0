...
def _create_summary_figure(df_detail: pd.DataFrame, craft_name: str) -> plt.Figure:
    ...
    bar_width = 0.6  # relative width of each bar
...
def _craft_dashboard_block(df_detail: pd.DataFrame) -> None:
    ...
    # the available width.  Using a mark size of 25 px gives a consistent
    # appearance across crafts.
    st.altair_chart(
        base.mark_bar(size=25).encode(
