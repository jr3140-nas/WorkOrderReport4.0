...
# === Mini-dashboard helpers (safe top-level) ===
...
_TYPE_COLORS = {
    ...
    "Follow Up Maintenance Order": "#d4c720", # yellow-ish
...
def _craft_dashboard_block(df_detail: pd.DataFrame):
    ...
    st.dataframe(
        agg.assign(percent=lambda d: d["percent"].round(1)).rename(columns={"percent":"% of Craft"}),
